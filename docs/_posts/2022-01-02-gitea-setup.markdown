...
layout: post
title:  "Gitea Setup"
date:   2022-01-02 00:00:08 +0100
categories: macos postgresql gitea
---

Hi all,

When I already have installed and configured the``PostgreSQL`` database I can set up the ``Gitea`` service.

I got started at the main web page of [``Gitea``](https://gitea.com).
