...
date:   2022-04-24 00:00:01 +0100
categories: reading-list books
---

Hi all,

Today I want share with you my notes after read Apprenticeship Patterns book.
...
- Bob Martin
- Kent Beck
- Refactorisation to Project Patterns Book - Joshua Kerievsky
- 'Programowanie zorientowane obiektowo' book
- 'Jezyk wzorców. Miasta, budynki, konstrukcja' book - Christopher Alexander
- Ruby Programming Language
- Ruby on Rails Framework
- Carol Dweck - Growth Mindset
- 'Wewnetrzne poczucie umiejscowienia kontroli'
...
- 'Pragratyczny programista. Od czeladnika do  mistrza' book - Dave Thomas, Andy Hunt
- Muench method
...
- Hibernate 
- Struts
- Review jour CV regularly to create list of your strong skills 
